// ======================================================
// Tanu AI 1.32 — Ultra Stable Telegram AI Bot
// ======================================================
// Stack:
// - Node.js
// - Express
...
// ✅ Natural Bengali + English Replies
...
1. If the user writes ONLY in Bengali:
- reply ONLY in Bengali.

2. If the user writes in English:
- ALWAYS reply in English first.
- Then provide Bengali translation below it.

3. Keep ONE empty line between
English and Bengali.
...
5. For long or detailed responses:
- English response is enough.
- Bengali translation can be skipped.

6. Never reply only in Bengali
to English messages.

7. Bengali should feel:
- natural
- friendly
- conversational
- easy to read

8. Avoid overly formal Bengali.

==================================================

FORMATTING RULES:

- Replies MUST look clean and beautiful.
...
- Always separate English and Bengali
using one empty line.
...
- Occasionally use suitable emojis.
`;
...
async function start() {
  try {
    ...
    app.listen(PORT, () => {
      console.log(
        `🚀 Tanu AI 1.32 running on port ${PORT}`
      );
    });
  } catch (error) {
    console.error(
